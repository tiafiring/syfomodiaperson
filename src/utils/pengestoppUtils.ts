...
export const allStoppAutomatikkStatusEndringer = (statusEndringer: StatusEndring[]) => {
    return statusEndringer.filter((statusEndring) => {
        return statusEndring.status === Status.STOPP_AUTOMATIKK;
    });
};

export const arbeidsgivereWithStoppAutomatikkStatus = (arbeidsgivere: Arbeidsgiver[], statusEndringerWithStoppAutomatikk: Array<StatusEndring>) => {
...
export const aktiveSykmeldingerFraSiste3Maneder = (sykmeldinger: Sykmelding[]) => {
...
export const unikeArbeidsgivereMedSykmeldingSiste3Maneder = (sykmeldinger: Sykmelding[]) => {

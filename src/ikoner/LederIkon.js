...
const LederIkon = () => {
    return (<svg contentScriptType="text/ecmascript" width="18px"
        contentStyleType="text/css" viewBox="0 0 18 18" height="18px"

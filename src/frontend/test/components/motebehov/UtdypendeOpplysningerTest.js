...
import UtdypendeOpplysninger from "../../../js/components/motebehov/UtdypendeOpplysninger";
...
describe('UtdypendeOpplysninger', () => {
    ...
    beforeEach(() => {
        ...
        komponent = shallow(<UtdypendeOpplysninger
            sykmelding={sykmelding}
        />);
    });

    it('Skal gi ingenting hvis ingen utdypendeOpplysninger', () => {
        komponent = mount(<UtdypendeOpplysninger
            sykmelding={sykmeldingUtenUtdypendeOpplysninger}
        />);
    ...
    it('Skal gi elementer hvis de gamle punktene i sykmeldingen er utfylt', () => {
        komponent = mount(<UtdypendeOpplysninger
            sykmelding={sykmeldingMedGamlePunkter}
        />);
    ...
    it('Skal gi elementer hvis de nye punktene i sykmeldingen er utfylt', () => {
        komponent = mount(<UtdypendeOpplysninger
            sykmelding={sykmeldingMedNyePunkter}
        />);
        expect(komponent.exists('div')).to.equal(true);
    });
});

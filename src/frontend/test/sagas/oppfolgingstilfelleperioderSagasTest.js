...
} from '../../js/actions/oppfolgingstilfelleperioder_actions';
import { hentOppfolgingstilfelleperioder } from '../../js/sagas/oppfolgingstilfelleperioderSagas';
...
describe('oppfolgingstilfelleSagas', () => {
    ...
    describe('hentOppfolgingstilfelleperioder', () => {
        ...
        it('Skal dernest kalle resttjenesten', () => {
            const nextCall = call(get, `${window.APP_SETTINGS.REST_ROOT}/oppfolgingstilfelleperioder?fnr=${fnr}&orgnummer=${orgnummer}`);

...
import { aktivEnhetSaga, pushModiacontextSaga, aktivBrukerSaga } from '../../js/sagas/modiacontextSagas';
import { HENTER_AKTIVENHET, PUSHER_MODIACONTEXT, HENTER_AKTIVBRUKER } from '../../js/actions/actiontyper';

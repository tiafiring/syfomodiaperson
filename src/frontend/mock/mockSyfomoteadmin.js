...
function mockEndepunkterSomEndrerState(server) {
    server.post('/moter/:uuid/avbryt', (req, res) => {
    ...
    server.post('/moter/:uuid/bekreft', (req, res) => {
    ...
    server.post('/moter/:uuid/nyealternativer', (req, res) => {

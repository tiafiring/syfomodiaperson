...
export const HENT_OPPFOLGINGSPLANER_LPS_FORESPURT = 'HENT_OPPFOLGINGSPLANER_LPS_FORESPURT';
export const HENT_OPPFOLGINGSPLANER_LPS_HENTER = 'HENT_OPPFOLGINGSPLANER_LPS_HENTER';
export const HENT_OPPFOLGINGSPLANER_LPS_HENTET = 'HENT_OPPFOLGINGSPLANER_LPS_HENTET';
export const HENT_OPPFOLGINGSPLANER_LPS_FEILET = 'HENT_OPPFOLGINGSPLANER_LPS_FEILET';

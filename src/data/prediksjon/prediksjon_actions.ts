import { Prediksjon } from "./prediksjon";
...
export const hentPrediksjon = (fnr: string) => ({
  type: HENT_PREDIKSJON_FORESPURT,
  fnr,
});
export const hentPrediksjonHentet = (data: Prediksjon, fnr: string) => ({
  type: HENT_PREDIKSJON_HENTET,
  data,
  fnr,
});

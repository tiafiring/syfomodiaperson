...
const DineSykmeldingOpplysninger = ({ sykmelding, ledetekster, Overskrift = 'h2' }) => {
    return (<div className="dine-opplysninger">
        ...
        <div className="blokk-l side-innhold">
            ...
            {
                getSykmeldingCheckbox(sykmelding.diagnose, 'svangerskap', texts.svangerskapTittel, 'blokk')
            }
            {
            ...
            {
                getSykmeldingCheckbox(sykmelding.friskmelding, 'arbeidsfoerEtterPerioden', texts.arbeidsforTittel, 'blokk')
            }
            {
                !sykmelding.friskmelding.hensynPaaArbeidsplassen ? null : <SykmeldingNokkelOpplysning
                    tittel={texts.hensynTittel}>
            ...
            }
            {
                sykmelding.arbeidsgiver ? <SykmeldingNokkelOpplysning
                    tittel={texts.arbeidsgiverTittel}>
                    <div>
                        <p className="js-arbeidsgiver">{sykmelding.arbeidsgiver}</p>
                        {
                            ...
                            sykmelding.stillingsprosent && (tidligsteFom(sykmelding.mulighetForArbeid.perioder) >= new Date('2018-04-26'))
                                ? <p className="js-stillingsprosent">{getStillingsprosentText(sykmelding.stillingsprosent)}`</p>
                                : null
                        }
                    </div>
                </SykmeldingNokkelOpplysning> : null

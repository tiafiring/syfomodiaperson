...
import MotebookingStatus, { PassertVarsel, StatusVarsel, kvitteringTekst } from '../../../src/mote/components/MotebookingStatus';
...
import { leggTilDagerPaaDato, trekkDagerFraDato } from '../../../src/mote/utils';
...
describe('MotebookingStatus', () => {
    ...
    describe('Når møtet ikke er bekreftet', () => {
        beforeEach(() => {
            component = shallow(<MotebookingStatus
                arbeidstaker={arbeidstaker}
                mote={mote}
                ledetekster={ledetekster}
            />);
    ...
    describe('Verktøylinje', () => {
        ...
        it('Skal kalle på avbrytMoteUtenVarsel med moteUuid og fnr når man klikker på knappen', () => {
            ...
            expect(avbrytMoteUtenVarsel.calledWith('min-mote-uuid', 'mitt-fnr')).to.be.equal(true);
        });
    });

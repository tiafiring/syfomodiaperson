...
export const KontaktinfoFeilmelding = () => {
    return (<div className="panel">
            <div className="hode hode-informasjon">
            <p>Arbeidstakers kontaktopplysninger kunne ikke hentes. Du kan fortsatt sende møteforespøsel til arbeidsgiver. Arbeidstaker må kontaktes på annen måte.</p>
        </div>
    </div>);
};
...
export const MotebookingSkjema = ({ handleSubmit, arbeidstaker, opprettMote, fnr, sender, sendingFeilet, ledere,
    ...
    return (<div>
        { !visArbeidstaker && <KontaktinfoFeilmelding /> }

...
describe("MotebookingSkjemaTest", () => {
    ...
    describe("genererDato", () => {
        it("Skal returnere dato på riktig format når dato er dd.mm.åååå", () => {
            ...
            expect(genererDato(dato, klokkeslett)).to.equal("2017-06-15T10:15:00.000");
        });
        ...
        it("Skal returnere dato på riktig format", () => {
            ...
            const dato = "15.06.2017";
            expect(genererDato(dato, klokkeslett)).to.equal("2017-06-14T23:15:00.000");
        });
    });
                ...
                deltakere: [
                    {
                        ...
                        "svar": [
                            {
                                "sted": "Oslo",
                                "tid": "2016-08-12T13:00:00.000",
                                "valgt":false,
                            },
                            {
                                "sted": "Oslo",
                                "tid": "2016-08-13T10:00:00.000",
                                "valgt":false,
                            }
                        ],
                    }

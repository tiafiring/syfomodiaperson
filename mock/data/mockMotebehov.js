const getMotebehovArbeidstakerUbehandlet = () => {
  return {
    UUID:
...
const getMotebehovArbeidstakerBehandlet = () => {
  return {
...
const getMotebehovArbeidsgiver = () => {
  return {
...
module.exports = {
  getMotebehovArbeidstakerUbehandlet,
  getMotebehovArbeidstakerBehandlet,
  getMotebehovArbeidsgiver,
};

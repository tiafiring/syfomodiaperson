...
export const mockIsdialogmote = (server) => {
  server.post(`${ISDIALOGMOTE_ROOT}/dialogmote/personident`, (req, res) => {
    if (
  ...
  server.get(`${ISDIALOGMOTE_ROOT}/dialogmote/personident`, (req, res) => {
    res.setHeader("Content-Type", "application/json");
    res.send(JSON.stringify(dialogmoterMock));
  });

  server.post(`${ISDIALOGMOTE_ROOT}/dialogmote/:moteuuid/avlys`, (req, res) => {
